...
* [미리 인증](<undefined-3 (1).md#undefined-4>)한 계정들로부터.
...
입금 승인이 활성화되어 있을 때 [결제 트랜잭션](../../references/xrp-ledger/undefined-1/undefined-1/payment.md)에서 돈을 받으려면, 당신은 그러한 지불의 발신자를 [미리 인증](<undefined-3 (1).md#undefined-4>)해야 합니다. _(_[_DepositPreauth 수정안_](../xrp-ledger/amendments/undefined.md#depositpreauth)_에 의해 추가되었습니다.)_
...
* [PaymentChannelClaim 트랜잭션](../../references/xrp-ledger/undefined-1/undefined-1/paymentchannelclaim.md)에서 XRP를 받을 수 있는 경우는 **다음의 경우들 뿐입니다**:
  ...
  * PaymentChannelClaim 트랜잭션의 목적지가 PaymentChannelClaim의 발신자를 [미리 인증](<undefined-3 (1).md#undefined-4>)한 경우. _(_[_DepositPreauth 수정안_](../xrp-ledger/amendments/undefined.md)_에 의해 추가됨)_

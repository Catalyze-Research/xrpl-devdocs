...
_(_[_NegativeUNL 수정안_](undefined-7/undefined.md)_에 의해 추가되었습니다.)_
...
* 유효성 검증인이 서버와 같은 프로토콜 규칙을 따르지 않는 경우. (설정 오류, 소프트웨어 버그, [다른 네트워크](undefined-10.md)를 의도적으로 따르거나 악의적인 동작 등 여러 가지 가능성이 있음)

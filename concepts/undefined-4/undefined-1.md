...
XRP Ledger의 기술은 실시간 정산(3\~6초)을 가능하게 하며, 통화 간에 가장 저렴한 거래 순서를 자동으로 사용하여 통화 간 연결을 제공하는 탈중앙화 거래소를 포함하고 있습니다.
...
2. 거래를 그룹에 포함시키는 데 어떤 이유든지 있을 경우, 모든 성실한 참여자는 해당 거래를 제외하기로 동의합니다. 거래가 여전히 유효한 경우, 다음 라운드에 포함시키기 위해 어떤 이유도 없으므로 모두 동의해야 합니다.

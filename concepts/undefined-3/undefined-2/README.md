...
동결 없음 설정은 해당 주소의 마스터 키 비밀로 서명된 트랜잭션으로만 활성화할 수 있습니다. [일반 키](../../../references/xrp-ledger/undefined-1/undefined-1/setregularkey.md)나 [다중 서명 트랜잭션](../../undefined-4/undefined/undefined-1.md)은 동결 없음을 활성화하는 데 사용할 수 없습니다.\

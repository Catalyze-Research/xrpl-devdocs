...
* 주소가 소유한 서명자 목록과 일치하는 [다중 서명](../undefined-2/undefined/undefined-1.md). [SignerListSet 트랜잭션](../../references/xrp-ledger/ledger/ledger-1/signerlist.md)을 사용하여 서명자 목록을 추가, 제거, 또는 교체할 수 있습니다.&#x20;
...
* [영구적으로 동결 기능을 포기할 수 있는 것](../undefined-4/undefined-2/)은 오직 마스터 개인 키 뿐입니다.&#x20;
* 당신은 주소에서 거래를 서명하는 마지막 방법을 절대 제거할 수 없습니다.&#x20;

마스터와 일반 키 페어에 대한 더 자세한 정보를 위해, [암호화 키](../undefined-2/undefined/undefined.md)를 참조해보세요.

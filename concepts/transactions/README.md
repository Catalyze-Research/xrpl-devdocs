...
6. 만약 충분한 [신뢰하 검증자](../xrp-ledger/rippled-rippled-server-modes.md)들이 완전히 같은 ledger을 생성했다면, 그 ledger는 _검증된_ 것으로 선언되고 그 ledger의 [트랜잭션 결과](../../references/xrp-ledger-xrp-ledger-protocol-reference/transaction-reference/pseudo-transactions/undefined/)는 불변의 특성을 가지게 됩니다.&#x20;
...
거래가 실행된 후, XRP Ledger는 거래의 최종 결과와 거래가 XRP Ledger의 공유 상태에 가한 모든 변경 사항을 보여주는 [메타데이터](../../references/xrp-ledger-xrp-ledger-protocol-reference/transaction-reference/pseudo-transactions/undefined-1.md)를 추가합니다.

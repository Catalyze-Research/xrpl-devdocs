...
인쇄 명령은 피어, ledger 클리너 및 리소스 관리자를 포함한 다양한 내부 하위 시스템의 현재 상태를 반환합니다.

인쇄 메소드는 권한이 없는 사용자가 실행할 수 없는 관리자 메소드입니다!
...
응답은 표준 형식을 따릅니다. 결과의 추가 필드는 rippled 서버의 내부 상태에 따라 달라집니다. 이 명령의 결과는 예고 없이 변경될 수 있습니다.
